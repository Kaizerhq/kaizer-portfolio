      ...
      <div style={{ width: "100%", maxWidth: 420, position: "relative" }}>
        ...
        <div style={{ border: "1px solid rgba(126,184,247,0.12)", padding: 40, background: "rgba(126,184,247,0.02)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            {mode === "register" && (
              <div>
                <label style={{ fontSize: 9, letterSpacing: 3, color: "#7eb8f7", display: "block", marginBottom: 8 }}>НУУЦ ҮГ ДАВТАХ</label>
        ...
        <p style={{ textAlign: "center", marginTop: 24, fontSize: 10, color: "rgba(126,184,247,0.3)" }}>
          <a href="/" style={{ color: "rgba(126,184,247,0.3)", textDecoration: "none" }}>← НҮҮР ХУУДАС</a>
        </p>
      </div>
    </div>
  );
